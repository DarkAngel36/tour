...
class ToursController extends Controller
{
	...
	public function actionSelect2() {
		...
		$period_id    = Yii::$app->request->get('period_id', 0);
		$parentsCount = Yii::$app->request->get('parentsCount', 0);
		$childCount   = Yii::$app->request->get('childCount', 0);
		
		$hotelModel  = Hotels::findOne($hotel_id);
		$periodModel = HotelsPeriod::findOne($period_id);
